...
export const ToolTipChangeSimilarClass = () => {
    return (<Tooltip
        title={<Box fontSize={14}>
            Chức năng thay đổi lớp: dành cho trường hợp 2 lớp liên quan, VD: lý thuyết + bài tập và thực hành,
            sinh viên muốn đổi lớp thực hành, nhưng vẫn muốn giữ lại lớp lý thuyết
            <br/>
            <br/>
